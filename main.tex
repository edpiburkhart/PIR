...
The first results were obtained with 100 points, with an execution time of over 100 seconds. The resulting diagram is show in Figure~\ref{fig:faessel1}.

\begin{figure}[t]
  \centering
  \includegraphics[width=.6\linewidth]{fig/faessel1}
  \caption{First results obtained with the Faessel method (N=100).}\label{fig:faessel1}
\end{figure}
